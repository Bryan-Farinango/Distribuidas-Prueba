 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://UDDI/", wsdlLocation = "http://localhost:8080/WebServicesDGIP/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://UDDI/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServicesDGIP/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://UDDI/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://UDDI/", "NewWebServicePort"), NewWebService.class, features);
    }
